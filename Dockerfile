...
RUN wget --quiet https://repo.anaconda.com/miniconda/Miniconda3-latest-Linux-${CONDA_ARCH}.sh -O ~/miniconda.sh && \
...
ADD https://github.com/krallin/tini/releases/download/${TINI_VERSION}/${TINI_ARCH} /usr/bin/tini
